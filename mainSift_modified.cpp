...
int main(int argc, char **argv)
{
  ...
  cv::Mat limg, rimg;
  cv::imread("data/SR300_capture_1.jpg", 0).convertTo(limg, CV_32FC1);
  cv::imread("data/SR300_capture_2.jpg", 0).convertTo(rimg, CV_32FC1);
  ...
  cv::imwrite("data/SR300_limg_pts.pgm", limg);
